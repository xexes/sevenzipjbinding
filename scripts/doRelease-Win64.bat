...
cmake ../SevenZipJBinding -G"MinGW Makefiles" -DUSE_MINGW_W64=Yes -DCMAKE_C_COMPILER=C:/MinGW-w64/bin/x86_64-w64-mingw32-gcc.exe -DCMAKE_CXX_COMPILER=C:/MinGW-w64/bin/x86_64-w64-mingw32-g++.exe "-DJAVA_JDK=C:/Program Files/Java/jdk1.8.0" -DBUILD_MYSPLIT=1  -DCMAKE_SHARED_LINKER_FLAGS="-specs C:\SevenZipJBinding\gcc64.specs"
